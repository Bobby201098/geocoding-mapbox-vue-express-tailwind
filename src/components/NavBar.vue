...
<fwb-navbar class="!bg-slate-300">
    <template #logo>
      <fwb-navbar-logo link="" alt="animus logo" image-url="https://i.ibb.co/prHgy8q/animus-01.png">
        ANIMUS
      </fwb-navbar-logo>
    </template>
    <template #default="{isShowMenu}" v-if="isAuthenticated">
      <fwb-navbar-collapse :isShowMenu="isShowMenu">
        <fwb-navbar-link :isActive="activeLink === 'home'" @click="setActiveLink('home')" link="/">Panou Principal</fwb-navbar-link>
        <fwb-navbar-link :isActive="activeLink === 'tabel'" @click="setActiveLink('tabel')" link="/tabel">Tabel Judete</fwb-navbar-link>
        <fwb-navbar-link :isActive="activeLink === 'membri'" @click="setActiveLink('membri')" link="/membri">Membri</fwb-navbar-link>
        <fwb-navbar-link :isActive="activeLink === 'setariProfil'" @click="setActiveLink('setariProfil')" link="/setariProfil">Setari</fwb-navbar-link>
      </fwb-navbar-collapse >
    </template>
    <template #right-side>

<button v-if="isAuthenticated" id="dropdownNotificationButton" data-dropdown-toggle="dropdownNotification" class="inline-flex items-center text-sm font-medium text-center text-gray-500 hover:text-gray-900 focus:outline-none dark:hover:text-white dark:text-gray-400" type="button"> 
...
<button v-if="isAuthenticated" id="dropdownUserAvatarButton" data-dropdown-toggle="dropdownAvatar" class="flex mx-4 text-sm bg-gray-800 rounded-full md:mr-0 focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600" type="button">
    <span class="sr-only">Open user menu</span>
    <img class="w-8 h-8 rounded-full" :src="user.picture" alt="user photo">
</button>

<!-- Dropdown menu -->
<div v-if="isAuthenticated" id="dropdownAvatar" class="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700 dark:divide-gray-600">
  ...
  FwbNavbarCollapse,
  FwbNavbarLink,
  FwbNavbarLogo} from 'flowbite-vue';
